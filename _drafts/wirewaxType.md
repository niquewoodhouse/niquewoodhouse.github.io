...
subtitle: Illustration / Typography
...
thumbNail:  assets/work/Thumbnail/WirewaxType@2x.png
tags:
- work
---
...
<div class="wider">
		      	...
		      	<div class="unit whole">
					<div class="iPad relative">
						<div class="iPadDot absolute">
					 	...
					 	<p class="smallPrint mAuto w50 smallGapTop">
					 		Video / Img of spatial interfaces --> video cards being combined into a project.  Sidebar number on project icon pops up.  Open projects tab, open project, videos open out of it.
					 	</p>
					</div>
		    	</div>	
		 </div>		
		...
		<div class="grid bigGapTop">
		      ...
		      <div class="unit two-thirds">
		      	...
		      	<p class="w80 fRight">
					...
					<img class="w80 fRight" src="assets/wirewax/WirewaxRetreatImg3.png"/>
					<img class="w80 fRight" src="assets/wirewax/WirewaxRetreatImg4.png"/>
					<img class="w80 fRight" src="assets/wirewax/WirewaxRetreatImg5.png"/>
					<img class="w80 fRight" src="assets/wirewax/WirewaxRetreatImg1.png"/>
		      </div>		      
		 </div>		 
	  ...
	  <div class="grid">
		      ...
		      <div class="unit one-third">
					<img src="assets/wirewax/WirewaxRetreatImg3.png"/>
		       </div>
		      <div class="unit one-third">
					<img src="assets/wirewax/WirewaxRetreatImg4.png"/>
		       </div>		  
		</div>
		...
		<div class="grid"> 
		      ...
		      <div class="unit one-third">
					<img src="assets/wirewax/WirewaxRetreatImg5.png"/>
		       </div>		
		      <div class="unit one-third">
					<img src="assets/wirewax/WirewaxRetreatImg1.png"/>
		       </div>		       	            
		 </div>	 
				...
				<div class="wider">
					<div class="grid ghost">
							<div class="unit one-third">
							 ...
							 <div class="unit two-thirds">
									<p>
										We tracked every action of user's audiences so we could educate on what is/isn't working for them.
									</p>		
									<p>
...
<div class="wider">			 
		 ...
		 <div class="grid bigGapTop bigGapBott"> 
		 	<div class="unit one-third relative">
		 		<span class="bigNo2 absolute w100 textCenter">
		 			08
		 		</span>
		...
		<div class="grid">
			<div class="unit whole ">
				...
				<h2 class="ColourQuote w50 mAuto smallGapBott textCenter">
					...
					You'll not accept that, suggest it was a team effort &amp; bouncing ideas off of others, but stick it &amp; take it.
				</h2>
