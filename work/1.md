...
<!-- 						<p class="s-print opacity07 xs-m-t">
					...
					<div class="one-third float-left m-m-t">
						<img class=" m-auto chapter m-m-b w50" src="../assets/work/gigbloc/search-calendar-1@2x.png"/>
					</div>	
...
<!-- 					<div class="one-third float-right">
		...
		<div class="storyline half xl-m-b chapter">
			<p>
				Recieving a gig should feel exciting, and whatever your response, Gigbloc should reward you.  
			</p>
		</div>		
...
<!-- 		<div class="storyline half xl-m-b chapter">
			<p>
				The day of the gig is a time to build anticipation and re-assure of all details. 
			</p>
		</div>	 -->
...
<div classer="wider">
		...
		<div class="grid l-m-t">
			<div class="storyline half l-m-b chapter">
				...
				<p>
					I really enjoyed the sprint aspects of this project.  We learned about what users might do relatively cheaply and I personally learned a lot about how enjoyable designing like this can be.  Designing used to be process where a designer gets a brief, disappears into a montage of pencil sharpening and paper crumpling, and returns from hibernation with a genius idea.  This sprint process feels better and smarter.  Its about teamwork.  Its about getting somethng out there and learning from it.  
				</p>					
				<p>
					Its a process that forces you to keep momentum day by day and thus build up energy.  Those forces are powerful and being super aware of them is something I'll certainly be taking into my next project.
				</p>
			</div>
