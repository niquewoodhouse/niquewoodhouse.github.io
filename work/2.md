...
<div class="wider light">
		<div class="grid">
				...
				<div class="half chapter m-m-b m-auto">
					<p>
						Brands not matching to spaces was costing resources, impacting revenue but utlimately killing the marketplace.  If brands can't book a space, they'll leave the platform.  If spaces can't get bookings, they will look elsewhere.  With 84% of brands struggling to 
					</p>
					<p class="bold">
