---
layout: work
title: Connecting the marketplace
subtitle: App / UI
longTitle: Improving a market leading platform
...
<div class="wider whitebg">
	...
	<div class="bigGapBott h90 bgCover" style="background-image:url('{{site.baseurl}}/assets/work/ahdestination/mag1.jpg')">
	</div>
	 ...
	 <div class="grid maxwidth1400 mAuto xl-m-b"> 
		<div class="unit whole dBlock xl-m-b xl-m-t">
	 	...
	 	<div class="unit whole">
	 		<img class="mediumGapBott dBlock mAuto" src="{{site.baseurl}}/assets/work/ahdestination/hackneytop1@2x.png"/> 
	 	</div>
...
<div class="wider">
		 ...
		 <div class="grid mediumGapBott maxwidth1400 mAuto">
		 	...
		 	<div class="unit one-third  ">
		 		<img class="dBlock mAuto w90" src="{{site.baseurl}}assets/work/ahdestination/hackneymobile1@2x.png"/> 
		 	</div>	
		 	<div class="unit one-third  ">
		 		<img class="dBlock mAuto w90" src="{{site.baseurl}}assets/work/ahdestination/hackneymobile2@2x.png"/> 
		 	</div>
		 	<div class="unit one-third ">
		 		<img class="dBlock mAuto  w90 fRight" src="{{site.baseurl}}/assets/work/ahdestination/hackneymobile3@2x.png"/> 
		 	</div>				 				 	
		 </div> 
		 	...
		 	<div class="unit whole smallestGapBott">
		 		<img class="dBlock mAuto" src="{{site.baseurl}}/assets/work/ahdestination/parislady1@2x.jpg"/> 
		 	</div>		
		...
		<div class="grid  mAuto maxwidth1400">
				...
				<div class="grid_item unit whole mediumGapBott">
					<img class="w90 mAuto" src="{{site.baseurl}}/assets/work/ahdestination/guideModal1@2x.png"/>	
				</div>
