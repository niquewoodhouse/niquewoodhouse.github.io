...
longTitle: Introducing a new feature into a complicated marketplace 
year: 2016
role: Designer

jobRole: Design Lead, <br>Product UX/UI Designer
jobOutput: Native responsive platform, <br>iOS App designs, branding
featureImg: assets/work/AHbranding/hero1.png
thumbNail: https://cdn.dribbble.com/users/966267/screenshots/3435914/cards_interaction_2.gif
client: Appear Here
---
<div class="wider">
		...
		<div class="grid">
				<div class="unit whole bigGapBott">
					<p class="w50 mAuto">
						Alongisde designing the product, I also design marketing &amp; brand collatoral for events Appear Here host in Paris &amp; London.
					</p>
				</div> 	
		</div>
		 ...
		 <div class="grid mediumGapBott">
		 	<div class="unit whole mediumGapBott">
		 		<img class="w90 dBlock mAuto" src="{{site.baseurl}}/assets/work/nick/vortex1.jpg"/> 
		 	</div>	
