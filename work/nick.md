...
featureImg: ../assets/work/Thumbnail/Nick@2x.png
thumbNail: ../assets/work/Thumbnail/Nick@2x.png
client: Nickelodeon
---
...
<div class="wider">
		...
		<div class="grid">
				<div class="unit whole bigGapBott chapter">
					<p class="w50 mAuto">
		 ...
		 <div class="grid mediumGapBott">
		 	<div class="unit whole mediumGapBott chapter">
		 		<img class="w90 dBlock mAuto" src="../assets/work/nick/vortex1.jpg"/> 
		 	</div>	
		 	<div class="unit whole w90 chapter">
		 ...
		 <div class="grid mediumGapBott chapter">
		 	<div class="unit whole mediumGapBott">
		 		<img class="w90 dBlock mAuto" src="../assets/work/nick/hugo1.jpg"/> 
		 	</div>	
		 	<div class="unit whole w90 mediumGapBott chapter">
		...
		<div class="grid">
				...
				<div class="grid_item unit half mediumGapBott chapter">
					<img class="w90 mAuto" src="../assets/work/nick/folio2015_gameAssets.png"/>	
				</div>
				<div class="unit half mediumGapBott  padding5 chapter">
